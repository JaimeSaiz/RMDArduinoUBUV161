...
#include "Arduino.h"
#include "RMDx8ArduinoUBUV161.h"
#include <mcp_can.h>

// constructor
RMDx8ArduinoUBUV161::RMDx8ArduinoUBUV161(MCP_CAN &CAN, const uint16_t motor_addr) 
    :_CAN(CAN){
        MOTOR_ADDRESS = motor_addr;
    }

void RMDx8ArduinoUBUV161::canSetup() {
...
*/
void RMDx8ArduinoUBUV161::readPID() {
    cmd_buf[0] = 0x30;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
 ...
 * turned off.
*/
void RMDx8ArduinoUBUV161::writePID(uint8_t anglePidKp, uint8_t anglePidKi, uint8_t speedPidKp, uint8_t speedPidKi, uint8_t iqPidKp, uint8_t iqPidKi) {
    cmd_buf[0] = 0x31;
    cmd_buf[1] = 0x00;
 ...
 * turned off.
*/
void RMDx8ArduinoUBUV161::writePIDROM(uint8_t anglePidKp, uint8_t anglePidKi, uint8_t speedPidKp, uint8_t speedPidKi, uint8_t iqPidKp, uint8_t iqPidKi) {
    cmd_buf[0] = 0x32;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = anglePidKp;
    cmd_buf[3] = anglePidKi;
...
*/
void RMDx8ArduinoUBUV161::readAccel() { 
    cmd_buf[0] = 0x33;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
...
*/
void RMDx8ArduinoUBUV161::writeAccel(uint32_t Accel) { 
    cmd_buf[0] = 0x34;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
...
*/
void RMDx8ArduinoUBUV161::readEncoder() { 
    cmd_buf[0] = 0x90;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
...
*/
void RMDx8ArduinoUBUV161::writeEncoderOffset(uint16_t encoderOffset) { 
    cmd_buf[0] = 0x91;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
...
*/
void RMDx8ArduinoUBUV161::writePositionROMMotorZero() { 
    cmd_buf[0] = 0x19;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
...
*/
void RMDx8ArduinoUBUV161::readMotorAngle() {
    cmd_buf[0] = 0x92;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
...
*/
void RMDx8ArduinoUBUV161::readSingleCircleAngle() { 
    cmd_buf[0] = 0x94;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
...
*/
void RMDx8ArduinoUBUV161::readStatus1() {
    cmd_buf[0] = 0x9A;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
 ...
 * The control value error_state determine the error produced.Each bit represents a different motor state.
*/
void RMDx8ArduinoUBUV161::clearErrorFlag() { 
    cmd_buf[0] = 0x9B;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
...
*/
void RMDx8ArduinoUBUV161::readStatus2() {
    cmd_buf[0] = 0x9C;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
...
*/
void RMDx8ArduinoUBUV161::readStatus3() {
    cmd_buf[0] = 0x9D;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
 ...
 * The motor responds to the host after receiving the command, the frame data is the same as the host sent
*/
void RMDx8ArduinoUBUV161::clearState() { 
    cmd_buf[0] = 0x80;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
 ...
 * The motor responds to the host after receiving the command, the frame data is the same as the host sent
*/
void RMDx8ArduinoUBUV161::stopMotor() {
    cmd_buf[0] = 0x81;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
 ...
 * The motor responds to the host after receiving the command, the frame data is the same as the host sent
*/
void RMDx8ArduinoUBUV161::resumeStopMotor() {
    cmd_buf[0] = 0x88;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
 ...
 */
void RMDx8ArduinoUBUV161::writeCurrent(int16_t iqControl) { 
    cmd_buf[0] = 0xA1;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
 ...
 * 	Encoder position value (uint16_t type, 14bit encoder value range (0, 16383)
 */
void RMDx8ArduinoUBUV161::writeSpeed(int32_t speedControl) { 
    cmd_buf[0] = 0xA2;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
 ...
 * 	Encoder position value (uint16_t type, 14bit encoder value range (0, 16383)
 */
void RMDx8ArduinoUBUV161::writePosition3(int32_t angleControl) { 
    cmd_buf[0] = 0xA3;
    cmd_buf[1] = 0x00;
    cmd_buf[2] = 0x00;
    cmd_buf[3] = 0x00;
 ...
 * 	Encoder position value (uint16_t type, 14bit encoder value range (0, 16383)
 */
void RMDx8ArduinoUBUV161::writePosition4(int32_t angleControl, uint16_t maxSpeed) { 
    cmd_buf[0] = 0xA4;
    cmd_buf[1] = 0x00;
 ...
 * 	Encoder position value (uint16_t type, 14bit encoder value range (0, 16383)
 */
void RMDx8ArduinoUBUV161::writePosition5(uint16_t angleControlST, uint8_t spinDirection) { 
    cmd_buf[0] = 0xA5;
 ...
 * 	Encoder position value (uint16_t type, 14bit encoder value range (0, 16383)
 */
void RMDx8ArduinoUBUV161::writePosition6(uint16_t angleControlST, uint16_t maxSpeed, uint8_t spinDirection) { 
    cmd_buf[0] = 0xA6;
    cmd_buf[1] = spinDirection;
    cmd_buf[2] = maxSpeed & 0xFF;
    cmd_buf[3] = (maxSpeed >> 8) & 0xFF;
 ...
 */
void RMDx8ArduinoUBUV161::multiMotorControl(int16_t iqControl_1, int16_t iqControl_2, int16_t iqControl_3, int16_t iqControl_4) { 
...
// General function
void RMDx8ArduinoUBUV161::serialWriteTerminator() {
    Serial.write(13);
    Serial.write(10);
}

// Private
void RMDx8ArduinoUBUV161::readBuf(unsigned char *buf) {
...
void RMDx8ArduinoUBUV161::writeCmd(unsigned char *buf) {
    unsigned char sendState = _CAN.sendMsgBuf(MOTOR_ADDRESS, 0, 8, buf);
    if (sendState != CAN_OK) { //  //
        Serial.println("Error Sending Message (RMDx8ArduinoUBUV161.h)...");
