#ifndef RMDArduinoUBUV161_h
#define RMDArduinoUBUV161_h

#include "Arduino.h"
#include <mcp_can.h>

class RMDArduinoUBUV161 {
public:
    unsigned char len;
    ...
    RMDArduinoUBUV161(MCP_CAN &CAN, const uint16_t motor_addr); // Maneja el controlador si tiene el mismo nombre que la clase
